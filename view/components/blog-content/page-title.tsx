...
function PageTitle({ description, title, blurImageSrc, icon: Icon }: IPageTitleProps) {
	return (
		<div className="relative flex flex-col items-center justify-center gap-5 border-b p-5 pb-12 text-center md:pb-20 md:pt-5">
			{Icon && (
