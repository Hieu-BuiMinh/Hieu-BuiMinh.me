...
cover: '/assets/images/dev-blog/common-copmponents-compilation/cover.png'
...
<Image src="/assets/images/dev-blog/common-copmponents-compilation/cover.png" alt="image-alt" />
	...
	data={[
		{
			content: (
				<Image
					src="/assets/images/dev-blog/how-to-build-a-blog-with-next-js-and-velite-js/cover.png"
