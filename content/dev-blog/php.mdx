---
id: '77980926-5baa-4b1c-b558-c1b0c82eecdc'
title: 'PHP.mdx'
...
published: true
hashTags: { category: 'Blog', tags: ['PHP'] }
---
...
<CodeBlock fileName="doc.html" caption="this is the caption">
```php {4} showLineNumbers /head/#v
<!DOCTYPE html>
<html>
    <head>
        <title>PHP</title>
